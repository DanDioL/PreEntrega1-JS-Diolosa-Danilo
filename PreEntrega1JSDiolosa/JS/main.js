...
const usuarios = ["danilo"];
const passwords = ["diolosa"];
...
if (menu === 1){
    ...
    switch (turno){
        ...
        case 2:
            ...
            break;
        case 3:
            alert("Su turno para Dermatologia fue asignado para el dia 14-04-2025 a las 12:37hs\nPor favor sea puntual")
            break;
        case 4:
            alert("Su turno para traumatologia fue asignado para el dia 25-12-2026 a las 00:00hs\nPor favor sea puntual")
            break;
        default:
